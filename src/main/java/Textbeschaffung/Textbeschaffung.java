...
public class Textbeschaffung implements NachrichtenBeschaffung{
            ...
            try {
                ...
                for (Iterator i = nachrichtenFeed.getEntries().iterator(); i.hasNext(); ) {
                    ...
                    if (nachricht.contains(keyword) == true) {
                        ...
                        artikelJSON = JSONbuilder.artikelJSONBuilder(artikelJSON, nachricht, headline); //Call method to build return JSON
    ...
    public JSONObject artikelJSONBuilder(JSONObject artikelJson, String News, String titel){ // Input are a JSON article, the news, and the headline
